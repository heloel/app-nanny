...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void agregarMarcador(double lat, double lng) {
        Toast.makeText(this,"Va Bien 3", Toast.LENGTH_SHORT).show();
    ...
    private void actualizarUbicacion(Location location) {
        if (location != null) {
            ...
            Toast.makeText(this,"Va Bien 2", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void miUbicacion() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(this,"Hay Algo mal!!!", Toast.LENGTH_SHORT).show();
            return;
        }

        Toast.makeText(this,"Va bien", Toast.LENGTH_SHORT).show();
